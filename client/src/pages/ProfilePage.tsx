...
const ProfilePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0a0a0a] text-slate-900 dark:text-slate-200 font-sans selection:bg-violet-500/30 pb-20 transition-colors">

      {/* Hero Banner with organic mesh gradient */}
      <div className="relative h-64 w-full overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-violet-200 via-indigo-200 to-slate-200 dark:from-violet-900 dark:via-indigo-900 dark:to-slate-900"></div>
        <div className="absolute top-0 right-0 w-full h-full bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-orange-300/30 dark:from-orange-500/20 via-transparent to-transparent opacity-70"></div>
        <div className="absolute bottom-0 left-0 w-full h-full bg-[radial-gradient(circle_at_bottom_left,_var(--tw-gradient-stops))] from-cyan-300/30 dark:from-cyan-500/20 via-transparent to-transparent opacity-70"></div>
        <div className="absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-slate-50 dark:from-[#0a0a0a] to-transparent"></div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 -mt-32">
        ...
        <div className="flex flex-col items-center text-center">
          <div className="relative group cursor-pointer">
            ...
            <img
              ...
              className="w-40 h-40 rounded-full object-cover border-4 border-slate-50 dark:border-[#0a0a0a] relative z-10 shadow-2xl transition-transform duration-500 group-hover:rotate-3 group-hover:scale-105"
            />
            <div className="absolute bottom-2 right-2 z-20 bg-slate-50 dark:bg-[#0a0a0a] text-amber-400 p-1.5 rounded-full border border-amber-500/30 shadow-lg">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-8 animate-in slide-in-from-bottom-4 fade-in duration-700 delay-200">
            <div className="bg-white dark:bg-[#111] hover:bg-slate-50 dark:hover:bg-[#161616] border border-slate-200 dark:border-white/5 px-6 py-3 rounded-2xl flex items-center gap-3 transition-all hover:scale-105 hover:border-violet-400 dark:hover:border-violet-500/30 group">
              <div className="bg-violet-500/20 p-2 rounded-lg text-violet-400 group-hover:text-violet-300">
                <Target className="w-5 h-5" />
              </div>
              <div className="text-left">
                <div className="text-3xl font-bold text-slate-900 dark:text-white leading-none">{user.totalScore}</div>
                <div className="text-[10px] text-slate-500 uppercase font-bold tracking-wider">Reputation</div>
              </div>
            </div>

            <div className="bg-white dark:bg-[#111] hover:bg-slate-50 dark:hover:bg-[#161616] border border-slate-200 dark:border-white/5 px-6 py-3 rounded-2xl flex items-center gap-3 transition-all hover:scale-105 hover:border-emerald-400 dark:hover:border-emerald-500/30 group">
            ...
            <div className="bg-white dark:bg-[#111] hover:bg-slate-50 dark:hover:bg-[#161616] border border-slate-200 dark:border-white/5 px-6 py-3 rounded-2xl flex items-center gap-3 transition-all hover:scale-105 hover:border-orange-400 dark:hover:border-orange-500/30 group">
              <div className="bg-orange-500/20 p-2 rounded-lg text-orange-400 group-hover:text-orange-300">
                <Target className="w-5 h-5" />
              </div>
              <div className="text-left">
                <div className="text-3xl font-bold text-slate-900 dark:text-white leading-none">{successRate}%</div>
        ...
        <div className="grid md:grid-cols-12 gap-6 mt-16 animate-in slide-in-from-bottom-8 fade-in duration-1000 delay-300">
          ...
          <div className="md:col-span-4 space-y-6">
            <div className="bg-white dark:bg-[#111] border border-slate-200 dark:border-white/5 rounded-3xl p-6 relative overflow-hidden group">
              ...
              <div className="space-y-5">
                <div>
                  <div className="flex justify-between text-xs font-bold text-slate-600 dark:text-slate-400 mb-1 uppercase tracking-wide">
              ...
              <div className="mt-8 pt-6 border-t border-slate-200 dark:border-white/5">
                ...
                <div className="flex flex-wrap gap-2">
                  {['React', 'Node.js', 'Python', 'Rust'].map(tag => (
                    <span key={tag} className="px-3 py-1 bg-slate-100 dark:bg-slate-800/50 text-slate-700 dark:text-slate-300 text-xs rounded-lg border border-slate-300 dark:border-white/5 hover:border-violet-400 dark:hover:border-violet-500/50 hover:bg-violet-100 dark:hover:bg-violet-900/20 transition-all cursor-default">
                      {tag}
                    </span>
                  ))}
                </div>
          ...
          <div className="md:col-span-8 space-y-6">
            ...
            <div className="bg-white dark:bg-[#111] border border-slate-200 dark:border-white/5 rounded-3xl p-8 relative overflow-hidden">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-1">Quest Log</h3>
                  <p className="text-sm text-slate-600 dark:text-slate-500">Contribution history over the last year</p>
                </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <div key={i} className={`rounded-2xl p-4 border ${badge.bg} flex flex-col items-center text-center transition-all hover:scale-105 hover:shadow-lg cursor-pointer group`}>
                  ...
                  <div className="font-bold text-slate-900 dark:text-white text-sm">{badge.name}</div>
                  <div className="text-[10px] text-slate-600 dark:text-slate-400 mt-1">{badge.desc}</div>
                </div>
              ))}
            </div>
