...
const ProblemsPage: React.FC = () => {
  ...
  return (
    <div className="page-container relative overflow-hidden">
      ...
      {/* Header */}
      <div className="border-b border-white/5 sticky top-0 z-20 bg-[#020617]/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-slate-100 tracking-tight">Challenges</h1>
              <p className="text-xs text-slate-400">Solve bugs, climb the ranks</p>
            </div>
          </div>
          ...
          <div className="relative group w-full max-w-md">
            ...
            <input
              ...
              className="bg-slate-900/50 border border-slate-800 text-slate-200 text-sm rounded-xl focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 block w-full pl-10 p-2.5 transition-all outline-none"
            />
          </div>
        </div>

        {/* Filter Bar */}
        <div className="border-t border-white/5 bg-[#020617]/50 backdrop-blur-md">
            ...
            {['easy', 'medium', 'hard'].map(diff => (
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-xs font-medium border transition-all duration-200 ${selectedDifficulty === diff
                  ...
                  : 'bg-slate-800/30 text-slate-400 border-slate-700/50 hover:bg-slate-800 hover:border-slate-600'
                  }`}
              >
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="flex gap-8">
                ...
                <div className="space-y-2">
                  {filteredChallenges.map((challenge, index) => (
                    ...
                    >
                      ...
                      <div className="relative glass rounded-xl border border-white/5 hover:border-primary-500/30 hover:bg-slate-800/60 p-4 transition-all duration-300 group-hover:translate-x-1">
          ...
          <div className="w-72 hidden lg:block space-y-6">
            <div className="glass rounded-xl p-5 border border-white/5 sticky top-40 animate-slide-up">
              ...
              <div className="space-y-4">
                <div className="bg-slate-900/50 rounded-lg p-3 border border-slate-800/50">
                  <div className="flex justify-between items-end mb-1">
                    <span className="text-slate-400 text-xs">Total Solved</span>
                    <span className="text-slate-200 font-bold text-lg">0 <span className="text-slate-600 text-xs font-normal">/ {filteredChallenges.length}</span></span>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="bg-slate-900/50 rounded-lg p-3 border border-slate-800/50 text-center">
                    <span className="text-xs text-slate-500 block mb-1">Easy</span>
                    <span className="text-emerald-400 font-bold">0</span>
                  </div>
                  <div className="bg-slate-900/50 rounded-lg p-3 border border-slate-800/50 text-center">
                    <span className="text-xs text-slate-500 block mb-1">Hard</span>
